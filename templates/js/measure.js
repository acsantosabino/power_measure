...
/***/ function(module, exports, __webpack_require__) {
	...
	var Device = __webpack_require__(/*! ./templates/src/Device */ 33);
	var Graph = __webpack_require__(/*! ./templates/src/Graph */ 35);
	var MyTable = __webpack_require__(/*! ./templates/src/MyTable */ 36);
	var ConsumeInfo = __webpack_require__(/*! ./templates/src/ConsumeInfo */ 37);
	...
	var Measure = React.createClass({
	  ...
	  render: function render() {
	    return React.createElement(
	      "div",
	      { className: "center" },
	      React.createElement(MyTable, { title: "History", url: "/api/history", pollInterval: "10000" }),
	      React.createElement(Graph, { url: "/fig/History_test2.svg", pollInterval: "20000", id: "graph1" }),
	      React.createElement(Device, { url: "/api/devinfo" }),
	      React.createElement(ConsumeInfo, { url: "/api/consumehistory", pollInterval: "20000" }),
	      React.createElement(Graph, { url: "/fig/ConsumeInfo.svg", pollInterval: "20000", id: "graph2" }),
	      React.createElement("div", { clasName: "clear" })
	    );
	  }
	});
	
	ReactDOM.render(React.createElement(Measure, null), document.getElementById('content'));
...
/* 33 */
/*!**********************************!*\
  !*** ./templates/src/Device.jsx ***!
  \**********************************/
/***/ function(module, exports, __webpack_require__) {

	'use strict';
	
	var $ = __webpack_require__(/*! jquery */ 34);
	var React = __webpack_require__(/*! react */ 1);
	...
	var Device = React.createClass({
	  ...
	  handleDevNameChange: function handleDevNameChange(e) {
	    this.setState({ dev_name: e.target.value });
	  },
	  handlePowerChange: function handlePowerChange(e) {
	    this.setState({ power: e.target.value });
	  },
	  handleConsumeClassChange: function handleConsumeClassChange(e) {
	    this.setState({ consume_class: e.target.value });
	  },
	  handleSubmit: function handleSubmit(devinfo) {
	  ...
	  render: function render() {
	    return React.createElement(
	      'div',
	      { className: 'box config', onLoad: this.loadCommentsFromServer },
	      React.createElement(
	        'form',
	        { className: 'devInfo', onSubmit: this.handleSubmit },
	        React.createElement(
	          'div',
	          null,
	          React.createElement(
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Graph = React.createClass({
	  ...
	  graphupdate: function graphupdate() {
	  ...
	  render: function render() {
	    return React.createElement(
	      'div',
	      { className: 'box graph' },
	      React.createElement('img', { src: this.props.url, id: this.props.id })
	    );
	  }
	});
	    ...
	    var tableFirstLine = this.props.data.map(function (measure, i) {
	      ...
	      if (i == 0) {
	        for (var index in measure) {
	          tableColums.push(React.createElement(
	            "th",
	...
	var MyTable = React.createClass({
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement(TableList, { data: this.state.data })
	    );
	  }
	});
	      ...
	      React.createElement(
	        ...
	        React.createElement(
	          ...
	          React.createElement(
	            "td",
	            null,
	            this.state.current_rms
	          ),
	          React.createElement(
	            "td",
	            null,
	            this.state.current_mean
	          )
	        ),
	        React.createElement(
	          "tr",
	          ...
	          React.createElement(
	            "td",
	            null,
	            this.state.voltage_rms
	          ),
	          React.createElement(
	            "td",
	            null,
	            this.state.voltage_mean
	          )
	        ),
	        React.createElement(
	          "tr",
	        ...
	        React.createElement(
	          ...
	          React.createElement(
	            "th",
	            null,
	            "Fator de Pot\xEAncia"
	          ),
	          React.createElement(
	            "td",
	            null,
	            this.state.power_factor
	          ),
	          React.createElement("td", null)
	        )
	      )
